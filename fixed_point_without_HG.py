...
PATH = 'fixed-point_without_HG/from real velocity'
Tic_real = globalVar.Tic11 * globalVar.zTotal * globalVar.pm
T_real = CN_N(Ts=globalVar.Ts, p=globalVar.pm, kappa=globalVar.kappa, u=globalVar.u, Tic=Tic_real)
Tp = T_real[-1, :]
